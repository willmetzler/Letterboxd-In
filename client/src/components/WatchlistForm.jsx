...
function WatchlistForm({ setUnwatchedMovies }) {
    ...
    function handleSubmit(event) {
        ...
        fetch("/api/watchlisted", {  // Ensure the URL matches the backend route
            method: 'POST',
            headers: {
        ...
        .then(newUnwatchedObj => {
            ...
            setUnwatchedMovies(unwatchedMovies => [newUnwatchedObj, ...unwatchedMovies]); // Add new movie to the start of the array
        })
